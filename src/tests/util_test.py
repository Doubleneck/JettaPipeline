...
class TestCredentialsValidation(unittest.TestCase):
    ...
    def test_password_and_password_repeat_must_match(self):
        ...
        self.assertTrue(validate_credentials(
            VALID_USERNAME, "Passw0rd", "Passw0rd"))
